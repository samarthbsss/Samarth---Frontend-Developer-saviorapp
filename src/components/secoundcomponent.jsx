...
import intro from "./Documents/Introduction.png";
  ...
  return (
    <div className="bg-black text-white py-12 px-4 md:flex md:items-center md:justify-between">
      <div className="md:w-1/2">
        ...
        <img src={intro} alt={intro} className="w-1/2 h-1/2 p-2 mb-4 m-auto" />
        <p className="mb-6">
        ...
        <a href="#read-more" className="text-blue-500 hover:text-blue-300">
          read more...
        </a>
